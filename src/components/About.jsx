  ...
  return (
    <>
      ...
      <div ref={ref} className="flex flex-col justify-center items-center ">
        ...
        <p className="text-slate-100 rounded-xl border border-blue-400 bg-blue-900 shadow-blue-300 shadow-md p-[5%] mb-40 sm:text-xl text-sm text-center w-[70%]">{portfolioData.intro}</p>
      </div>
    </>
  )
}
